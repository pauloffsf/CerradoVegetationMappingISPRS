...
training classes for Grassland Types. Function is called within ToLevel3_TrainGrassland
...
for the training the Grassland types. This fuction calls changeClass within.
...
'''
def ToLevel3_TrainGrassland(end, saveRef=False):
