...
training classes for Forest Types. Function is called within ToLevel3_TrainForest
...
for the training the Forest types. This fuction calls changeClass within.
...
'''
def ToLevel3_TrainForest(end, saveRef=False):
